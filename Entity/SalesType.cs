...
namespace BackOffice.Entity
{
    public class SalesType
    {
        ...
        public required short ForcePrice { get; set; } = 0;
        public required short Tax1Exempt { get; set; } = 0;
        public required short Tax2Exempt { get; set; } = 0;
        public required short Tax3Exempt { get; set; } = 0;
        public required short Tax4Exempt { get; set; } = 0;
        public required short Tax5Exempt { get; set; } = 0;
